...
const Hero: FC = () => {
  return (
    <Container className="tablet:h-[80vh]">
      <section className="w-full xl:w-[60%] ultrawide:w-[50%] flex flex-col tablet:flex-row items-center justify-between gap-20 tablet:gap-0 my-24 tablet:my-16 mx-10 xl:mx-0">
