...
const App: FC = () => {
  const buttonClass =
    "hover:scale-110 hover:duration-500 hover:cursor-pointer w-[160px] xl:min-w-[205px]";
      ...
      <div className="w-[60%] h-auto flex flex-col tablet:flex-row justify-between gap-4 tablet:gap-10 xl:gap-28">
        <div className="scale-75 lg:scale-90 xl:scale-95 2xl:scale-100 relative flex items-center justify-center gap-3 xl:py-20 rounded-[50px]">
          ...
          <Image
            ...
            alt="LibertyPay app"
          />
          {/* <div className="absolute w-[440px] h-[440px] bg-regular-green rounded-full z-[1]"></div> */}
          {/* <div className="absolute w-[440px] h-[440px] bg-regular-green/50 rounded-[50px] z-[1]"></div> */}
        ...
        <div className="flex flex-col items-center tablet:items-start justify-center gap-12">
          ...
          <div className="flex gap-4 lg:gap-4 flex-col min-w-[160px] xl:flex-row">
            <a
