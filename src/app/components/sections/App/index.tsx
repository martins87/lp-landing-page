...
const App: FC = () => {
  ...
  return (
    <Container>
      <section className="w-full tablet:w-[60%] h-auto flex flex-col tablet:flex-row justify-between gap-4 tablet:gap-10 xl:gap-28 mx-10 xl:mx-0 my-24 tablet:my-16">
