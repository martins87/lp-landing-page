...
const AgentVsApp: FC = () => {
  return (
    <div className="w-full h-screen flex justify-center bg-white">
      <div className="w-[75%] h-[80%] flex items-center justify-around gap-10">
        <div className="w-[42.5%] h-[800px] flex flex-col justify-between p-14 bg-really-light-green rounded-[50px]">
          <div className="flex flex-col flex-1 gap-4">
            <h2 className="text-green text-3xl font-bold">
              Licensed Agent Stores
            </h2>
            <h5 className="text-green font-sans font-normal text-[22px]">
        ...
        <div className="w-[42.5%] h-[800px] flex flex-col justify-between p-14 bg-slate-50 rounded-[50px]">
          ...
          <div className="flex flex-col">
            <div className="flex flex-col">
              ...
              <h5 className="text-green font-sans font-normal text-[22px] mt-4">
